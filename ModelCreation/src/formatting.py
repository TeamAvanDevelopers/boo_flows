...
"""
def related_tags_format(idx, created_time, related_tags_dict):
    return dict({"idx": idx, "created_time": created_time, 'related_tags': related_tags_dict})

def related_items_format(idx, created_time, related_items_dict):
    return dict({"idx": idx, "created_time": created_time, 'related_posts': related_items_dict})
